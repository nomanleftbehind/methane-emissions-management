use crate::{
    ...
    graphql::{
        context::ContextExt, models::MonthBeginningValidator, sql::insert_compressor_month_vents,
    },
};
...
impl CompressorMonthVentMutation {
    async fn insert_compressor_month_vents(
        ...
        let rows_inserted = insert_compressor_month_vents(pool, user_id, &months, c1, co2)
            .await
            .map_err(Error::from);
